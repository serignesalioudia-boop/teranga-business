...
const links = [
  { href: "/seller", label: "Tableau de bord" },
  { href: "/seller/products", label: "Produits" },
  { href: "/seller/categories", label: "Catégories" },
  { href: "/seller/orders", label: "Commandes" },
  { href: "/seller/analytics", label: "Analytics" },
  { href: "/seller/revenue", label: "Revenus" },
  { href: "/seller/settings", label: "Paramètres" },
];
  ...
  return (
    <>
      ...
      <aside
        ...
        `}
      >
        <Link href="/seller" className="mb-6 block text-lg font-bold" onClick={() => setOpen(false)}>
          Vendeur
        </Link>
